...
init_clock(void)
{
	...
	kclockinfo.boottime = 0;
	kclockinfo.uptime = 0;
	kclockinfo.realtime = 0;
	...
	kclockinfo._rsvd1 = 0; /* these are for future use */
	kclockinfo._rsvd2 = 0; /* until then, no information leaks.. */

	adjtime_delta = 0;

	/* Load average data initialization. */
	kloadinfo.proc_last_slot = 0;
	for (i = 0; i < _LOAD_HISTORY; i++)
		kloadinfo.proc_load_history[i] = 0;
}
