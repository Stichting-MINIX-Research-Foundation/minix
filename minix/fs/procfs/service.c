...
enum policy {
	POL_NONE = 0,		/*     user	| endpoint	*/
	POL_RESET,		/* visible	|  change	*/
	POL_FRESH,		/* transparent  |  change	*/
...
service_get_policies(struct policies * pol, index_t slot)
{
	...
	static const struct {
		...
		/* bus */
                { .label = "i2c", .policy_str = "" },
                { .label = "pci", .policy_str = "" },
                { .label = "ti1225", .policy_str = "" },
		/* clock */
                { .label = "readclock.drv", .policy_str = "" },
		/* eeprom */
                { .label = "cat24c256", .policy_str = "" },
		/* examples */
                { .label = "hello", .policy_str = "" },
		/* hid */
                { .label = "pckbd", .policy_str = "fresh" },
		/* iommu */
		...
		/* sensors */
                ...
                { .label = "sht21", .policy_str = "" },
                { .label = "tsl2550", .policy_str = "" },
		/* storage */
                { .label = "ahci", .policy_str = "fresh" },
                { .label = "at_wini", .policy_str = "fresh" },
                { .label = "fbd", .policy_str = "" },
                { .label = "filter", .policy_str = "" },
                { .label = "floppy", .policy_str = "" },
                { .label = "memory", .policy_str = "" },
                { .label = "mmc", .policy_str = "" },
                { .label = "virtio_blk", .policy_str = "fresh" },
                { .label = "vnd", .policy_str = "" },
		/* system */
                { .label = "gpio", .policy_str = "" },
		...
		/* net */
                { .label = "inet", .policy_str = "fresh" },
                { .label = "lwip", .policy_str = "" },
		/* servers */
                { .label = "devman", .policy_str = "" },
                { .label = "ds", .policy_str = "" },
                { .label = "input", .policy_str = "fresh" },
