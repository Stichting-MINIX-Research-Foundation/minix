/*	$NetBSD: ex_argv.c,v 1.3 2014/01/26 21:43:45 christos Exp $ */
/*-
...
#endif /* not lint */
#else
__RCSID("$NetBSD: ex_argv.c,v 1.3 2014/01/26 21:43:45 christos Exp $");
#endif
 ...
 *
 * PUBLIC: int argv_exp0 __P((SCR *, EXCMD *, const CHAR_T *, size_t));
 */
int
 ...
 *	the argument list.
 *
 * PUBLIC: int argv_exp2 __P((SCR *, EXCMD *, const CHAR_T *, size_t));
 */
int
 ...
 *
 * PUBLIC: int argv_exp3 __P((SCR *, EXCMD *, const CHAR_T *, size_t));
 */
int
