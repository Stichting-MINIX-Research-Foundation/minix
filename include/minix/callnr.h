...
/* Request code 0 is traditionally reserved. */
#define PM_EXIT			(PM_BASE +   1)
#define PM_FORK			(PM_BASE +   2)
#define PM_WAITPID		(PM_BASE +  11)
#define PM_GETPID		(PM_BASE +  20)
#define PM_SETUID		(PM_BASE +  23)
#define PM_GETUID		(PM_BASE +  24)
#define PM_STIME		(PM_BASE +  25)
#define PM_PTRACE		(PM_BASE +  26)
#define PM_GETEPINFO		(PM_BASE +  31)
#define PM_SETGROUPS		(PM_BASE +  32)
#define PM_GETGROUPS		(PM_BASE +  34)
#define PM_KILL			(PM_BASE +  37)
#define PM_SETGID		(PM_BASE +  46)
#define PM_GETGID		(PM_BASE +  47)
#define PM_EXEC			(PM_BASE +  59)
#define PM_SETSID		(PM_BASE +  62)
#define PM_GETPGRP		(PM_BASE +  63)
#define PM_ITIMER		(PM_BASE +  64)
#define PM_GETMCONTEXT		(PM_BASE +  67)
#define PM_SETMCONTEXT		(PM_BASE +  68)
#define PM_SIGACTION		(PM_BASE +  71)
#define PM_SIGSUSPEND		(PM_BASE +  72)
#define PM_SIGPENDING		(PM_BASE +  73)
#define PM_SIGPROCMASK		(PM_BASE +  74)
#define PM_SIGRETURN		(PM_BASE +  75)
#define PM_REBOOT		(PM_BASE +  76)
#define PM_SVRCTL		(PM_BASE +  77)
#define PM_SYSUNAME		(PM_BASE +  78)
#define PM_GETPRIORITY		(PM_BASE +  88)
#define PM_SETPRIORITY		(PM_BASE +  89)
#define PM_GETTIMEOFDAY		(PM_BASE +  90)
#define PM_SETEUID		(PM_BASE +  91)
#define PM_SETEGID		(PM_BASE +  92)
#define PM_SPROF		(PM_BASE +  98)
#define PM_CPROF		(PM_BASE +  99)
#define PM_NEWEXEC		(PM_BASE + 100)
#define PM_SRV_FORK		(PM_BASE + 101)
#define PM_EXEC_RESTART		(PM_BASE + 102)
#define PM_GETPROCNR		(PM_BASE + 104)
#define PM_ISSETUGID		(PM_BASE + 106)
#define PM_SRV_KILL		(PM_BASE + 111)
#define PM_GETSID		(PM_BASE + 113)
#define PM_CLOCK_GETRES		(PM_BASE + 114)
#define PM_CLOCK_GETTIME	(PM_BASE + 115)
#define PM_CLOCK_SETTIME	(PM_BASE + 116)
#define PM_GETRUSAGE		(PM_BASE + 123)
#define PM_GETSYSINFO		(PM_BASE + 125)

#define NR_PM_CALLS		126	/* highest number from base plus one */
...
#define PM_EXEC_FLAGS		m1_i3	/* int XXX OBSOLETE IN 3.3.0 */
#define PM_EXEC_PS_STR		m1_p3	/* char * XXX NEW IN 3.3.0; *NOT* p4 */
...
#define VFS_BASE		0x000	/* XXX CHANGE ME FOR 3.3.0 */

#define IS_VFS_CALL(type)	(((type) & ~0xff) == VFS_BASE)

#define VFS_READ		(VFS_BASE +   3)
#define VFS_WRITE		(VFS_BASE +   4)
#define VFS_OPEN		(VFS_BASE +   5)
#define VFS_CLOSE		(VFS_BASE +   6)
#define VFS_LINK		(VFS_BASE +   9)
#define VFS_UNLINK		(VFS_BASE +  10)
#define VFS_CHDIR		(VFS_BASE +  12)
#define VFS_MKNOD		(VFS_BASE +  14)
#define VFS_CHMOD		(VFS_BASE +  15)
#define VFS_CHOWN		(VFS_BASE +  16)
#define VFS_LSEEK		(VFS_BASE +  19)
#define VFS_MOUNT		(VFS_BASE +  21)
#define VFS_UMOUNT		(VFS_BASE +  22)
#define VFS_ACCESS		(VFS_BASE +  33)
#define VFS_SYNC		(VFS_BASE +  36)
#define VFS_RENAME		(VFS_BASE +  38)
#define VFS_RMDIR		(VFS_BASE +  40)
#define VFS_SYMLINK		(VFS_BASE +  45)
#define VFS_READLINK		(VFS_BASE +  49)
#define VFS_STAT		(VFS_BASE +  51)
#define VFS_FSTAT		(VFS_BASE +  52)
#define VFS_LSTAT		(VFS_BASE +  53)
#define VFS_IOCTL		(VFS_BASE +  54)
#define VFS_FCNTL		(VFS_BASE +  55)
#define VFS_COPYFD		(VFS_BASE +  56)
#define VFS_PIPE2		(VFS_BASE +  58)
#define VFS_UMASK		(VFS_BASE +  60)
#define VFS_CHROOT		(VFS_BASE +  61)
#define VFS_GETDENTS_330	(VFS_BASE +  69) /* XXX SORT OUT FOR 3.3.0 */
#define VFS_FTRUNCATE_330	(VFS_BASE +  70) /* XXX SORT OUT FOR 3.3.0 */
#define VFS_GETDENTS		(VFS_BASE +  80)
#define VFS_LLSEEK		(VFS_BASE +  81) /* XXX SORT OUT FOR 3.3.0 */
#define VFS_SELECT		(VFS_BASE +  85)
#define VFS_FCHDIR		(VFS_BASE +  86)
#define VFS_FSYNC		(VFS_BASE +  87)
#define VFS_TRUNCATE		(VFS_BASE +  93)
#define VFS_FTRUNCATE		(VFS_BASE +  94)
#define VFS_FCHMOD		(VFS_BASE +  95)
#define VFS_FCHOWN		(VFS_BASE +  96)
#define VFS_LSEEK_330		(VFS_BASE +  97) /* XXX SORT OUT FOR 3.3.0 */
#define VFS_UTIMENS		(VFS_BASE + 108)
#define VFS_FCNTL_330		(VFS_BASE + 109) /* XXX SORT OUT FOR 3.3.0 */
#define VFS_TRUNCATE_330	(VFS_BASE + 110) /* XXX SORT OUT FOR 3.3.0 */
#define VFS_GCOV_FLUSH		(VFS_BASE + 112)
#define VFS_VMCALL		(VFS_BASE + 117)
#define VFS_GETVFSSTAT		(VFS_BASE + 118)
#define VFS_STATVFS1 	 	(VFS_BASE + 119)
#define VFS_FSTATVFS1		(VFS_BASE + 120)
#define VFS_MAPDRIVER		(VFS_BASE + 122)
#define VFS_CHECKPERMS		(VFS_BASE + 124)
#define VFS_GETSYSINFO		(VFS_BASE + 126)
#define VFS_GETRUSAGE		(VFS_BASE + 127)
#define VFS_SVRCTL		(VFS_BASE + 128)
#define VFS_CREAT		(VFS_BASE + 129)
#define VFS_MKDIR		(VFS_BASE + 130)

#define NR_VFS_CALLS		131	/* highest number from base plus one */
