...
#define SIG_ENDPT      m_u.m_sigcalls.ep     /* process number for inform */
#define SIG_NUMBER     m_u.m_sigcalls.sig    /* signal number to send */
#define SIG_FLAGS      m_u.m_sigcalls.flags  /* signal flags field */
#define SIG_MAP        m_u.m_sigcalls.sigs   /* used to pass signal bit map */
#define SIG_CTXT_PTR   m_u.m_sigcalls.sigctx /* pointer to signal context */
#define SIG_HOW        m_u.m_sigcalls.how   /* used to pass signal bit map */
