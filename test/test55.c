...
static int do_getvfsstat(struct statvfs *buf, size_t bufsz, int flags,
	int count)
{
	int i, j;
...
static void compare_statvfs(struct statvfs *st1, struct statvfs *st2)
{
	int i;
