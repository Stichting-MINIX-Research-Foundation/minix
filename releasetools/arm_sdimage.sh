...
#
./releasetools/fetch_u-boot.sh -o ${IMG_DIR}/u-boot -n $U_BOOT_GIT_VERSION
cp ${IMG_DIR}/u-boot/${U_BOOT_BIN_DIR}/u-boot.img ${IMG_DIR}/
cp ${IMG_DIR}/u-boot/${U_BOOT_BIN_DIR}/MLO ${IMG_DIR}/
