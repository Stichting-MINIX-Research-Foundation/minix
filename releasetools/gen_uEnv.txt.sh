...
echo "mmcbootcmd=echo starting from MMC ; mmc part 0; mw.b 0x87800000 0 16384 $(fill_cmd "fatload mmc 0:1" "") ; dcache off ; icache off ; go 0x80200000"
echo 
echo "# Netbooting."
...
echo "netbootcmd=echo starting from TFTP; mw.b 0x87800000 0 16384 $(fill_cmd "tftp" "$NETBOOT_PREFIX") ; dcache off ; icache off ; go 0x80200000"
exit 0
